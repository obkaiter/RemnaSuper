...
SHAPER_CONFIG_DIR="/etc/remnasuper/traffic-shaper"
SHAPER_SERVICE_NAME="remnasuper-traffic-shaper.service"
SHAPER_SERVICE_FILE="/etc/systemd/system/$SHAPER_SERVICE_NAME"
SHAPER_PIN_DIR="/sys/fs/bpf/remnasuper-traffic-shaper"
SHAPER_RULES_FILE="$SHAPER_CONFIG_DIR/rules.json"
SHAPER_WHITELIST_FILE="$SHAPER_CONFIG_DIR/whitelist.txt"
SHAPER_INTERFACE_FILE="$SHAPER_CONFIG_DIR/interface.conf"
SHAPER_CONTROLLER="$SHAPER_CONFIG_DIR/controller.py"
